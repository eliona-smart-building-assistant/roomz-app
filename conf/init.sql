...
create schema if not exists roomz;
...
create table if not exists roomz.asset
(
	id               bigserial primary key,
	configuration_id bigserial not null references roomz.configuration(id) ON DELETE CASCADE,
